...
namespace SubconverterTools.BaseData
{
    ...
    public class RemoteConfigs
    {
        ...
        public static List<SelectItem> GetItem()
        {
            ...
            {
                new SelectItem("不选，系统默认", "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini"),
                ...
                new SelectItem("[个人定制]ACL4SSR_Online_Full_NoCountry 无国家分类", "https://raw.githubusercontent.com/ZeroDeng01/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_NoCountry.ini"),

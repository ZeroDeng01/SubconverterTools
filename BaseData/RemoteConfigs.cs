    ...
    public class RemoteConfigs
    {
        ...
        public static List<SelectItem> GetItem()
        {
            var remoteConfigs = new List<SelectItem>
            {
                ...
                new SelectItem("ACL4SSR_Online_Mini_Ai.ini 精简版 带OpenAi(与Github同步)", "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Mini_Ai.ini"),
